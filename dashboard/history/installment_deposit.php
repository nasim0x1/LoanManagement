<?php require_once("../../includes/config.php");?>
    ...
    <head>
        ...
        <title>Installment Deposit History - DKBSSL</title>
    ...
    <li class="breadcrumb-item active" aria-current="page">Installment List</li>
  </ol>
</nav>

                <div class="container-fluid">
                        <div id="data" class="last_added_client">
                        <center><font size="5px" style="color:#0F82C8;font-weight: bold;"> Installment Deposit History </font></center><br>
            ...
            $query = "SELECT * FROM installment_deposit ORDER BY id DESC";
                ...
                if ($result = $conn->query($query)) {
                    while ($row = $result->fetch_assoc()) {
                        ...
                        echo '
                        <td align="center"><a href="loan_status.php?loan_no='.$loan.'">'.$loan.'</a></td>
