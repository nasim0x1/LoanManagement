<?php
 ...
 ?>
    ...
    <head>
        ...
        <title>Loan No <?php echo $loan_no;?> Installment Deposit History - DKBSSL</title>
        ...
        <div class="d-flex" id="wrapper">
            ...
            <div id="page-content-wrapper">
                ...
                <div class="container-fluid">
                        ...
                        <center><font size="5px" style="color:#0F82C8;font-weight: bold;"> Loan NO : <?php echo $loan_no;?> <?php $query = mysqli_query($conn, "SELECT * FROM loan_list WHERE loan_no='".$loan_no."'");if(mysqli_num_rows($query) > 0 == false ){echo "<font color='red'>Not Found</font>";}?></font></center><br>
            ...
            $k = $count["k"]+1;
                ...
                if ($result = $conn->query($query)) {
                    while ($row = $result->fetch_assoc()) {
                        ...
                        if($due == 0){
                            $due_ = "<div class='badge badge-success'>Closed</div>";
                        }else{
                            $due_ = "$due ৳";
                        }
                ...
                ?>
                        ...
                        <hr class="style2">
                        <?php 
                            $sql = "SELECT SUM(amount) as amount FROM installment_deposit where loan_no = '$loan_no'";
                            $sth = $conn->query($sql);
